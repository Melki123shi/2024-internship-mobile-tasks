...
import 'package:melkishitesfaye/features/product/presentatoin/widget/button.dart';
        ...
        child: BlocConsumer<ProductBloc, ProductState>(
          ...
          builder: (context, state) {
            ...
            if (state is SucessUpdateProduct) {
              ...
              // showSnackBar(context, 'Succesflully Updated');
                        ...
                        child: Center(
                          child: Stack(
                            ...
                            children: <Widget>[
                              ...
                              if (imageFile == null)
                                Image.network(
                                  // state.product.imageFile!.path ??
                                  widget.image!,
                                  // 'https://www.freepik.com/free-psd/podium-mockup-display-product-presentation-decorated-with-cute-tropical-leaves_26860193.htm#fromView=search&page=1&position=3&uuid=85c33b42-8583-42db-9b77-6be0fd014e88',
                                  fit: BoxFit.cover,
                                ),
                              Center(
                                child: Text(
